...
import type { BuyerProfile as _BuyerProfile, Product as _Product, ProductCategory as _ProductCategory, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: bigint, arg1: string, arg2: bigint, arg3: ProductCategory): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, arg1, arg2, to_candid_ProductCategory_n1(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async assignVendor(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.assignVendor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerBuyerProfile(): Promise<BuyerProfile | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerBuyerProfile();
                return from_candid_opt_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCallerBuyerProfile(arg0: BuyerProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCallerBuyerProfile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BuyerProfile]): BuyerProfile | null {
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "groceries" in value ? ProductCategory.groceries : "snacks" in value ? ProductCategory.snacks : "householdToiletries" in value ? ProductCategory.householdToiletries : "fruits" in value ? ProductCategory.fruits : "spices" in value ? ProductCategory.spices : "beverages" in value ? ProductCategory.beverages : "vegetables" in value ? ProductCategory.vegetables : value;
}
